...
public class QnA {
	...
	public QnA(String account_id, String qna_title, String qna_content, String name) {
		super();
	...
	public QnA(String account_id, String qna_title, String qna_content, String name, int hotel_id) {
		super();
		this.account_id = account_id;
