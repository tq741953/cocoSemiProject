...
/**
 * Servlet implementation class HotelQnADeleteServlet
 */
@WebServlet("/qna/delete2")
public class HotelQnADeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HotelQnADeleteServlet() {
        super();
