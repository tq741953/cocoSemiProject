...
<body>
	...
	<div class="bigTitle">기업 회원가입</div><br>
	<div class="outer">
	<br>
		<div id="joinArea">
			<form id="joinForm" action="<%= request.getContextPath() %>/account/insert2"
			method="post" enctype="multipart/form-data" onsubmit="return joinValidate();">
				...
				<div id=joininside>
					...
					<div id="joinAll">
						...
						<input type="password" maxlength="15" class="inputText" name="password" required>
						</div>
					</div>
					<div id="joinAll">
						<div class="join_title"><div class="title">비밀번호 확인</div></div>
						<div class="input_area">
						<input type="password" maxlength="15" class="inputText" name="password2" required>
						</div>
					...
					<div id="joinAll">
						<div class="join_title"><div class="title">이름</div></div>
							<div class="input_area">
								<input type="text" maxlength="5" class="inputText" name="userName" required>
							</div>
					</div>
					<div id="joinAll">
					...
					<div id="joinAll">
						<div class="join_title"><div class="title">사업자 번호</div></div>
						<div class="input_area">
						<input type="text" maxlength="12" class="inputText" name="bLicense" placeholder="XXX-XX-XXXXX" required>
						</div>
					</div>
					<div id="joinAll">
						<div class="join_title"><div class="title">첨부파일</div></div>
						<div class="input_area">
						<label class="input-file-button" for="imgFile">업로드</label>
						<input type="file" id="imgFile" name="imgFile" style="display:none" required>
						</div>
						<div class="hotelname"><pre class="hotelname">* 사업자등록증<br>첨부 필수</pre></div>
					</div>
					<div id="joinAll">
						<div class="join_title"><div class="title">회원타입</div></div>
						<div class="input_area">
						<input type="text" name="name" class="inputText" placeholder="기업회원" readonly>
						</div>
					</div>
					<div class="btnArea">
						<button class="btn btn-secondary" id="goMainBtn" type="button">메인으로</button>	
						<button class="btn btn-secondary" id="joinBtn">가입하기</button>
						<button class="btn btn-secondary" id="goBackBtn" onclick="history.back()">뒤로가기</button>
					</div>
				</div>
			</form>
		</div>
