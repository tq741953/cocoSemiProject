...
<style>
   ...
   #name:focus {outline:2px solid rgb(52, 58, 64);}
   #email:focus {outline:2px solid rgb(52, 58, 64);}
...
<body>
	...
	<div class="bigTitle">아이디 찾기</div><br>
	<div class="outer">
	<br>
		<div id="findArea">
			<form id="findForm" action="<%= request.getContextPath() %>/account/findId"
			method="post" onsubmit="return Validate();">
				...
				<div id=findinside>
					<div id="findAll">
						...
						<input type="text" maxlength="13" id = "name" name="name" required>
						</div>
					</div>
					<div id="findAll">
					...
					<div class="btnArea">
						<button class="btn btn-secondary" id="findIdBtn" type="submit">아이디 찾기</button><br>
