    ...
    <div class="outer">
                ...
                <form action="<%= request.getContextPath() %>/review/insert" method="post">
                	...
                	<div class="input_area">
                      <input type="number" name="no" value="<%= r.getReservation_no() %>" readonly>
                    </div>
                    ...
                    <div class="input_area">
                        <input type="text" name="createDate" value="<%= today %>" readonly>
                    </div><br>
                    ...
                    <div class="textarea2">
                      ...
                      <textarea name="content" id="answert" cols="" rows=""></textarea>
                    </div>
                    ...
                    <div class="btnArea">
                        ...
                        <button type="submit" class="btn btn-secondary" id="insertBtn">작성</button>
